...
def animation_function(i):
	...
	cpu_data = open("D:\\Python\\NetworkApp3\\cpu.txt").readlines()
	
	#Creating an empty list which to append each value in the file converted from string to float;
	x = []
	...
	#Clearing /refreshing the figure to avoid unnecessary overwriting for each new poll (every 10 sec)
	subplot.clear()
...
#Using the figure, the function and a polling interval of 1000ms (10 sec) to build the graph
